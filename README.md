## Motivation
  ...
  Some options that provide similar functionality are [AWS Cloud9](https://aws.amazon.com/cloud9/), [Visual Studio Codespaces](https://visualstudio.microsoft.com/services/visual-studio-codespaces/), and [GitHub Codespaces](https://github.com/features/codespaces/). VS Codespaces is pretty cool as well, but I have found it difficult to connect to a repository [outside of GitHub](https://docs.microsoft.com/en-us/visualstudio/online/reference/repository).
